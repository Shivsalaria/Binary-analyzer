...
//     return (
//         <div className={`min-h-screen font-sans ${darkMode ? 'bg-[#1f2937] text-gray-100' : 'bg-gray-50 text-gray-900'}`}>
//             <nav className={`${darkMode ? 'bg-[#1f2937] border-gray-700' : 'bg-white border-gray-200'} border-b`}>
//                 <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
//                     <div className="flex justify-between h-16">
//                         <div className="flex items-center">
//                             <Link to="/" className="flex items-center">
//                                 <Shield className="h-10 w-10 text-indigo-500" />
//                                 <span className="ml-2 text-xl font-bold">Malware Analysis</span>
//                             </Link>
//                         </div>
//                     </div>
//                 </div>
...
//                 <button className="w-full max-w-md p-4 border rounded-md text-center" onClick={handleGoogleLogin}>
